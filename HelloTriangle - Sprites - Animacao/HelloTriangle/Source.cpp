...
//#endif
	...
	GLuint texID = generateTexture("../../textures/wall.jpg", bgwidth, bgheight);
	//GLuint texID2 = generateTexture("../../textures/wall.jpg", charwidth, charheight);
	//Lista 2 exercicio 5
	Sprite imagem1;
	imagem1.initialize(texID, bgwidth, bgheight);
	imagem1.setShader(&shader);
	imagem1.setPosition(glm::vec3(100, 100, 0));
	imagem1.setScale(glm::vec3(bgwidth *0.3, bgheight *0.3, 1));


	Sprite imagem2;
	imagem2.initialize(texID, bgwidth, bgheight);
	imagem2.setShader(&shader);
	imagem2.setPosition(glm::vec3(100, 300, 0));
	imagem2.setScale(glm::vec3(bgwidth*0.3, bgheight*0.3, 1));
	
	Sprite imagem3;
	imagem3.initialize(texID, bgwidth, bgheight);
	imagem3.setShader(&shader);
	imagem3.setPosition(glm::vec3(400, 100, 0));
	imagem3.setScale(glm::vec3(bgwidth * 0.3, bgheight * 0.3, 1));

	Sprite imagem4;
	imagem4.initialize(texID, bgwidth, bgheight);
	imagem4.setShader(&shader);
	imagem4.setPosition(glm::vec3(400, 300, 0));
	imagem4.setScale(glm::vec3(bgwidth * 0.3, bgheight * 0.3, 1));
